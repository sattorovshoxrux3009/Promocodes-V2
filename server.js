...
const services = {
  ...
  "🛸 Exprees24": {
    ...
    promo: {
      uz: `💛 Express24\n\n 🎁  EKE9S- promokodi 80 000 so’mdan oshgan birinchi buyurtma uchun 35 000 so’m chegirma\n\n‼️ Promokod barcha kafe,restorant va do'konlar ishlaydi\n\n@yandeks_telegram`,
      ru: `💛 Express24\n\n 🎁 EKE9S- промокод скидка 35 000 сумов на первый заказ от 80 000 сумов\n\n‼️ Промокод действует во всех кафе, ресторанах и магазинах\n\n@yandex_telegram`,
      en: `💛 Express24\n\n 🎁 EKE9S- promo code 35,000 soums discount for the first order over 80,000 soums\n\n‼️ Promo code works in all cafes, restaurants and shops\n\n@yandex_telegram`,
    },
  },
  "🥦 Yandex Магазин": {
  ...
  "🛍️ Yandex Market": {
    ...
    promo: {
      uz: `✅ Promokod:  - -50% Chegirma istalgan xaridlar uchun (Maximal 80,000 soʻm)\n\n@yandeks_telegram`,
      ru: `✅ Промокод: - -50% Скидка на любые покупки (Максимум 80 000 сумов)\n\n@yandex_telegram`,
      en: `✅ Promo code: - -50% Discount for any purchases (Maximum 80,000 soums)\n\n@yandex_telegram`,
    },
  },
  "📭 Umumiy ma'lumotlar": {
